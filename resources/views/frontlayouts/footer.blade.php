<section class="app_olx">
            ...
            <img src="{{ url('public/frontend/images/footer1.png') }}" alt="app" class="olx_app">
            </div>
            ...
            <span><img src="{{ url('public/frontend/images/appstore_2x.png') }}"></span> <span><img src="{{ url('public/frontend/images/playstore_2x.png') }}"></span>
            </div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-lg-3 col-sm-6 col-12 fiiter_wrap-item">
					...
					<ul class="social_icons">
						...
						<p class="footer_apps-wrap"><span class="footer_olx-app"><img src="{{ url('public/frontend/images/appstore_2x.png') }}"></span> <span class="footer_olx-app"><img src="{{ url('public/frontend/images/playstore_2x.png') }}"></span></p>
					</ul>
				</div>
			</div>
		</div>
