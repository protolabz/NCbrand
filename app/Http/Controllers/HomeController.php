...
class HomeController extends Controller
{
    ...
    {   
       ...
       foreach($products as $pro){
           $product_image = Product_Image::select('image')->where('prod_id',$pro->id)->first();
           $pro->product_image = $product_image->image;
           
       }
       $slider_images = Product::leftjoin('product__images','products.id','=','product__images.prod_id')->orderBy('products.id','desc')->get();
        ...
        { 
           ...
           $product = Product::select("*");
            ...
            {
                $product->orderBy('products.title','asc',$request->input('sort'));           
           ...
           foreach($product as $pro){
            ...
            return response()->json(view('frontend.products.include.product', ['products' => $product,'images' => $images,'vendors' => $vendors])->render());
                                               
                                                           
      
        }    
       
        return response()->view('frontend.products.shop', compact('products','images','vendors','slider_images'));
    }
    ...
    { 
        if($id){
            ...
            if(!empty($product)){
                ...
                $vendor = Vendor::where('id',$vendid)->first();
            }
           $images = Product_Image::where('prod_id',$id)->get();
            ...
            return view('singleproductnew',compact('product','vendor'));
        }
